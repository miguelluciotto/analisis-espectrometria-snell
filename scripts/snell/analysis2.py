...
# Carga de datos
file_path = "../../data/snell/tabla2.csv"
...
plt.title(
    ...
    Interfaz Acrílico $\\rightarrow$ Aire
    """)
...
plt.grid(True)
plt.tight_layout()
plt.savefig("../../graphs/reflexion_plot2.png", dpi=300)
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("../../graphs/refraction_plot2.png", dpi=300)
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("../../graphs/fit_refraction_plot2.png", dpi=300)
plt.show()
