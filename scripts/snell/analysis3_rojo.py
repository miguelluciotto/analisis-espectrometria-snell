...
# Carga de datos
file_path = "../../data/snell/tabla3_rojo.csv"
...
## RIT
plt.xlim(0, 75)
plt.axvline(42.5, color="purple", linestyle=":", label=r"Ángulo crítico experimental: $\theta_c \approx 42.5 ^\circ$")
plt.axvspan(42.5, 75, color="purple", alpha=0.1, label="Zona de reflexión interna total")

plt.title(
    """Comprobación experimental de la Ley de Reflexión $\\theta_1$ vs $\\theta_2$
    Interfaz Acrílico $\\rightarrow$ Aire usando el filtro rojo
    """)
...
plt.grid(True)
plt.tight_layout()
plt.savefig("../../graphs/reflexion_plot3_rojo.png", dpi=300)
plt.show()
...
plt.axvline(42.5, color="purple", linestyle=":", label=r"Ángulo crítico experimental: $\theta_c \approx 42 ^\circ$")
plt.axvspan(42.5, 50, color="purple", alpha=0.1, label="Zona de reflexión interna total")
...
plt.grid(True)
plt.tight_layout()
plt.savefig("../../graphs/refraction_plot3_rojo.png", dpi=300)
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("../../graphs/fit_refraction_plot3_rojo.png", dpi=300)
plt.show()
